...
\usepackage{graphicx}
\usepackage[export]{adjustbox}%Per il Frame attron ole immagini
\usepackage{subfig}
...
\usepackage{caption}
\captionsetup{tableposition=top,figureposition=bottom,font=small}\captionsetup{format=hang,labelfont={bf,color=myGray}} %didascalie a più righe allineate e il nome in grassetto
...
\input{CHAPTERS/CHAP2_Trave.tex}
\input{CHAPTERS/CHAP3_P27.tex}
\input{CHAPTERS/CHAP4_P36.tex}
\input{CHAPTERS/APPENDIX1_CodiceTrave.tex}
\end{document}
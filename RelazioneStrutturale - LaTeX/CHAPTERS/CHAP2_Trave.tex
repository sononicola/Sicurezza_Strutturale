...
Per il calcolo del coefficiente di pressione $c_p$ si è preso come riferimento il \normaref{\S\,C3.3.8.1.2} riguardante le coperture piane: non essendo infatti elencati nelle normative casi specifici per i terrazzi.
...
\caption{Valori del taglio con combinazione di carico SLU nei punti più significativi della struttura}
	\begin{tabular}{lS[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]}
		\toprule
		&\multicolumn{1}{c}{Nodo 1}&\multicolumn{1}{c}{Nodo 2}&\multicolumn{1}{c}{Nodo 3}&\multicolumn{1}{c}{Nodo 4}&\multicolumn{1}{c}{Nodo 5}&\multicolumn{1}{c}{Nodo 6}&\multicolumn{1}{c}{Nodo 7}\\
		\midrule

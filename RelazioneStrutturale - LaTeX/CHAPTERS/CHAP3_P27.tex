...
\begin{figure}[htbp]
\centering
\subfloat[][\emph{Piano Terra}]{\includegraphics[trim=14.2cm 8.8cm 9.7cm 6.9cm,clip,frame]{IMG/Piante/Piante-PT-P27.pdf}} \quad
\subfloat[][\emph{Piano Primo}]{\includegraphics[trim=14.2cm 8.8cm 9.7cm 6.9cm,clip,frame]{IMG/Piante/Piante-P1-P27.pdf}} \\
\subfloat[][\emph{Piano Secondo}]{\includegraphics[trim=14.2cm 8.8cm 9.7cm 6.9cm,clip,frame]{IMG/Piante/Piante-P2-P27.pdf}} \quad
\subfloat[][\emph{Piano Copertura}]{\includegraphics[trim=14.2cm 8.8cm 9.7cm 6.9cm,clip,frame]{IMG/Piante/Piante-PC-P27.pdf}} \\
...
\input{IMG/NomenclaturaAree.tex}
...
\begin{align*} 
	SLU^{\text{sfav}}_{\text{P27}}		 &= \SI{1416}{\kilo\newton} \\	
	SLE^{\text{rara}}_{\text{P27}} 		 &= \SI{990.8}{\kilo\newton} \\
	SLE^{\text{frequente}}_{\text{P27}}  &= \SI{878.0}{\kilo\newton} \\
	SLE^{\text{quasi perm.}}_{\text{P27}}&= \SI{839.1}{\kilo\newton}
\end{align*}
\e di seguito riportato l'andamento dei carichi in funzione della quota dell'edificio.
Come si vede si ha un valore costante nel passaggio tra un piano e l'altro ed un andamento lineare crescente lungo l'altezza del pilastro dovuto al peso proprio crescente.

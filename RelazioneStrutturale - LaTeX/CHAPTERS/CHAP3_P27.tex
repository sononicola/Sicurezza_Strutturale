...
\begin{figure}[htbp]
\centering
\subfloat[][\emph{Piano Terra}]{\includegraphics[trim=17.5cm 6.5cm 7cm 9.7cm,clip,frame]{IMG/Piante/Piante-PT.pdf}} \quad
\subfloat[][\emph{Piano Primo}]{\includegraphics[trim=17.5cm 6.5cm 7cm 9.7cm,clip,frame]{IMG/Piante/Piante-P1.pdf}} \\
\subfloat[][\emph{Piano Secondo}]{\includegraphics[trim=17.5cm 6.5cm 7cm 9.7cm,clip,frame]{IMG/Piante/Piante-P2.pdf}} \quad
\subfloat[][\emph{Piano Copertura}]{\includegraphics[trim=17.5cm 6.5cm 7cm 9.7cm,clip,frame]{IMG/Piante/Piante-PC.pdf}} \\
